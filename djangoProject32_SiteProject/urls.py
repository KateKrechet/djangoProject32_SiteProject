...
# login
# забыли пароль
# reset_form - заполнили почту
# reset_done - сообщение о том, что письмо отправлено
# reset_confirm - замена пароля
# reset_complete - сообщение о том, что пароль изменен